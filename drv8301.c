...
void InitDRV8301Regs(MOTOR_VARS * motor)
{
	...
	motor->drv8301.cntrl_reg1.bit.GATE_CURRENT = drv8301_gateCurrent_1700mA;
	motor->drv8301.cntrl_reg1.bit.PWM_MODE     = drv8301_pwmMode_6;
	motor->drv8301.cntrl_reg1.bit.OC_MODE      = drv8301_ocp_sd;
	motor->drv8301.cntrl_reg1.bit.OC_ADJ_SET   = drv8301_oc_358mV;
